<div class="json-schema-view mapper-schema-path" ng-class="{'collapsed': isCollapsed, 'mapper-schema-container': !isPrimitive && !isRoot}" data-ng-attr-path="{{::getPath()}}" data-ng-attr-dimensions="{{::getDimensionArray()}}" data-ng-attr-container="{{::getContainer()}}">

...
var JavaObject = 'java.lang.Object';
var List = 'java.util.List'; // Not exported!
var Map = 'java.util.Map'; // Also not exported!
...
Encoder.prototype.addBoolean = function(val) {
  this.addSimpleValue(val, Boolean, 'boolean');
};
...
Encoder.prototype.addString = function(val) {
  this.addSimpleValue(val, String);
};
...
Encoder.prototype.addInteger = function(val) {
  this.addSimpleValue(val, Integer);
};
...
Encoder.prototype.addDouble = function(val) {
  this.addSimpleValue(val, Double);
};
...
Encoder.prototype.addList = function(arr, type) {
  ...
  this.payload.signature.push(List);
};
...
Encoder.prototype.addMap = function(map, keyType, valueType, isComplexKey) {
  ...
  this.payload.signature.push(Map);

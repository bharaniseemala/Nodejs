...
var encode = require('./util').encodeLibertyPath;
...
exports.attributeDataTypes = attributeDataTypes;
exports.COLLECTIVE_MBEAN_PATH = COLLECTIVE_MBEAN_PATH;
exports.COLLECTIVE_REPOSITORY_OPERATIONS = COLLECTIVE_REPOSITORY_OPERATIONS;
exports.SetApplicationRoutingInfo = SetApplicationRoutingInfo;
exports.SetEndPointRoutingInfo = SetEndPointRoutingInfo;
 ...
 */
function SetApplicationRoutingInfo(options, operation) {
 ...
 * the collective repository of the controller.
 */
function SetApplicationState(options, operation) {
  mandatory(options.host, 'missing host');
  mandatory(options.userDir, 'missing userDir');
  mandatory(options.server, 'missing server');
  mandatory(options.applicationName, 'missing applicationName');
 ...
 * the collective repository of the controller.
 */
function SetEndPointRoutingInfo(options, operation) {

 ...
 * @param {string} options.acceptUnauthorized - Accept unauthorized HTTPS
 * certificates if the server uses them. Common during initial join.
 * @param {string} options.checkServerIdentity - Whether to verify
 * that server's hostname matches the CN in the TLS certificate.
 * Defaults to `true`.
 * @param {string} options.ca - A PEM encoded CA certificate to trust as
 * as an HTTPS certificate issuer.
 * @param {string} options.username - The username used for Basic auth with
 * the endpoint.
 * @param {string} options.password - The password used for Basic auth with
 * the endpoint.
 * @param {string} options.pfx - The client identity.
 * @param {string} options.pfxPassphrase - The pfx passphrase.
 * @param {function} options.request - Inject a request function compatible

...
angular.module('apim.apis').controller('ApiEditorController', ['$scope', '$rootScope', '$sanitize', '$http', '$stateParams', '$location', '$timeout', '$state', '$modal', '$filter', '$window', 'Api', 'UserRegistry', 'Product', 'SSLProfile', 'Oauth', 'SchemaForm', 'VendorExtension', 'ApiValidators', 'DirtyService', 'ComponentRegistry', 'SlugService', 'validateWorkerFunctionFactory', 'validateWorkerFactory', 'LocationService', 'TrackingServices', ApiEditorController]);

function ApiEditorController($scope, $rootScope, $sanitize, $http, $stateParams, $location, $timeout, $state, $modal, $filter, $window, Api, UserRegistry, Product, SSLProfile, Oauth, SchemaForm, VendorExtension, ApiValidators, DirtyService, ComponentRegistry, SlugService, validateWorkerFunctionFactory, validateWorkerFactory, LocationService, TrackingServices) {
  ...
  $scope.sanitizeDescription = function() {
    if ($scope.swaggerDocument && $scope.swaggerDocument.info) {
      $scope.sanitizedDescription = $sanitize($scope.swaggerDocument.info.description);
    }
  };

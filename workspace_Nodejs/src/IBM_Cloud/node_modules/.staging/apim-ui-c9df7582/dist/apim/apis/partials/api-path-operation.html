  ...
  <div class="operationRenderer marginLeft10 marginRight10" data-ng-if="$ctrl.isExpanded()">
    ...
    <div data-ng-controller="ContentTypeController">
      ...
      <div class="bx--form__row-item">
        <bx-checkbox aria-label="{{::'api_consume_inherit' | translate}}" data-ng-model="$inheritConsumes" data-ng-model-options="{getterSetter:true}">
      ...
      <div class="bx--form__row-item">
        <bx-checkbox aria-label="{{::'api_produce_inherit' | translate}}" data-ng-model="$inheritProduces" data-ng-model-options="{getterSetter:true}">

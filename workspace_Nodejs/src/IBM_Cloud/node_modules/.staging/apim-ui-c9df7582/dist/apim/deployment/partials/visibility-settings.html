...
<div>
	<div class="bx--form__row">
      ...
      <div class="tagContainer publishContainer" data-ng-show="visibleTo == 'custom' && $parent.tags.length > 0 && (!environment || permissions[spaceId ? spaceId + '/space_developers/view' : environment.id + '/catalog_developers/view']) && !disableVisibility" data-ng-controller="AvailabilityViewController as availabilityViewController">
      ...
      <div class="visibilityTags tagContainer publishContainer" data-ng-show="visibleTo == 'custom' && !environment">
        <div class="tagContainer" data-ng-class="{'undeletable': disableVisibility}">
  ...
  <div class="bx--form__row--item">
    ...
    <div class="bx--select labeledSelect">
      ...
      <div class="tagContainer publishContainer" data-ng-show="subscribableBy == 'custom' && !disableSubscribability && $parent.tags.length > 0 && (!environment || permissions[spaceId ? spaceId + '/space_developers/view' : environment.id + '/catalog_developers/view'])" data-ng-controller="AvailabilitySubscribeController as availabilitySubscribeController">
      ...
      <div class="visibilityTags tagContainer publishContainer" data-ng-show="subscribableBy == 'custom' && !environment">
        <div class="tagContainer" data-ng-class="{'undeletable': disableVisibility}">

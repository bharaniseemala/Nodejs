  ...
  <div data-ng-switch-default>
    ...
    <div class="primaryBorder" style="margin-bottom: 15px;">
      ...
      <ul class="simpleList productVersions cardContainer">
        <li data-ng-repeat="productVersion in filteredProductVersions = (productVersions | deploymentNameOnlyQuery: productVersionQuery | otherPublishedProductVersions: productVersion)" ng-class-even="'bxTableRowEven'" ng-class-odd="'bxTableRowOdd'">

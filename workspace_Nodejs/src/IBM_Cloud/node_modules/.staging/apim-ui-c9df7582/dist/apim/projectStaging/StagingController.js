...
function getLoginServer(host) {
  return (host.indexOf('apiconnect.ibmcloud.com') === -1 &&  host.indexOf('apim.ibmcloud.com') === -1 ? 'https://login-service-apiconnect' + host.substr(host.indexOf('.'), host.length) : 'https://login.service.' + host);
}

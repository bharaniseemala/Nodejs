    ...
    <div class="bx--form__fieldset">
        ...
        <div>
            <bx-input-container>
                ...
                <input title="{{::'product_name' | translate}}" class="marginBottom10 createProductName" data-ng-model="newProduct.name" required data-ng-pattern="/^[A-Za-z0-9-_]+$/" ng-trim="false"/>
            </bx-input-container>
        </div>
        <div>
            <bx-input-container>

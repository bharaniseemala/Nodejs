...
angular.module('apim.products', []).controller('ProductEditorController', ['$scope', '$rootScope', '$sanitize', '$timeout', '$http', '$modal', '$location', '$stateParams', 'Product', 'ProductUtil', 'DeployedProduct', 'Api', 'ApiSearch', 'Reference', 'DirtyService', 'TrackingServices', ProductEditorController]);

function ProductEditorController($scope, $rootScope, $sanitize, $timeout, $http, $modal, $location, $stateParams, Product, ProductUtil, DeployedProduct, Api, ApiSearch, Reference, DirtyService, TrackingServices) {
  ...
  $scope.sanitizeDescription = function() {
    if ($scope.product && $scope.product.info) {
      $scope.sanitizedDescription = $sanitize($scope.product.info.description);
    }
  };

      ...
      $scope.gatewayClusters.forEach(function(cluster) {
        ...
        $scope.selectedGatewayClusters.forEach(function(selectedCluster) {
          if (selectedCluster.id === clusterId) {
            ...
            var endpointUrlName = selectedCluster.endpointUrl.split('\/').pop();
            if (endpointUrlName !== $scope.selectedEnvironment.shortName) { // Catalog name change should propagate to endpointUrl
              selectedCluster.endpointUrl = selectedCluster.endpointUrl.substring(0, selectedCluster.endpointUrl.length - endpointUrlName.length) + $scope.selectedEnvironment.shortName;
            }
          }
        });
      });

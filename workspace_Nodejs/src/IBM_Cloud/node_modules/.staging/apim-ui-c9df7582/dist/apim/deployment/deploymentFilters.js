      ...
      for (var j = 0; j < supersededPlans.length; j++) {
        if (supersededPlans[j] == plan.planName) {
          ...
          if (superseder.length > 0) {
            productName = superseder[0].document.info.title;
            productVersionNumber = superseder[0].document.info.version;
            planShortName = thisSupersedingProduct[supersededPlans[j]];
            planName = superseder[0].document.plans[planShortName].title;
            return {

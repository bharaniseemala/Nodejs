...
function approvalsController($scope, Approval, Environment) {
  ...
  $scope.$watch('permissions', function() {
    ...
    if ($scope.permissions[$scope.spaceId ? envId + '/<<_approvalAnySpace_>>/view' : '<<_approvalAnyEnv_>>/view'] ||
      $scope.permissions[$scope.spaceId ? $scope.spaceId + '/space_planSubscriptions/view' : envId + '/catalog_planSubscriptions/view'] ||
      $scope.permissions[$scope.spaceId ? envId + '/<<_deploymentAnySpace_>>/view' : '<<_deploymentAnyEnv_>>/view'] ||
      $scope.permissions[$scope.spaceId ? envId + '/<<_deploymentAnySpace_>>/manage' : '<<_deploymentAnyEnv_>>/manage'] ||
      $scope.permissions[$scope.spaceId ? $scope.spaceId + '/space_subscriptionApproval/view' : envId + '/space_subscriptionApproval/view'] ||
      $scope.permissions[$scope.spaceId ? $scope.spaceId + '/space_subscriptionApproval/manage' : envId + '/space_subscriptionApproval/manage']) {

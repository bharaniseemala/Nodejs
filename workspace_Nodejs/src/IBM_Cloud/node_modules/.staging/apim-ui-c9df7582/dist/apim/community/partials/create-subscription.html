...
<div class="bx--modal-content community webapi" data-ng-switch="currentPage">
  <div data-ng-switch-default>
    ...
    <div class="primaryBorder bx--form__row-item">
      ...
      <ul class="simpleList boundedList">
  ...
  <div data-ng-switch-when="2">
    ...
    <div class="primaryBorder bx--form__row-item">
      ...
      <ul class="simpleList boundedList productVersions">
      ...
      <div class="mediumPadding" data-ng-show="filteredProductVersions.length == 0">{{productVersions | deploymentProductReplaceNoDescriptors: planVersionQuery}}</div>
    </div>
  </div>
</div>
<!-- footer -->

...
var DEFAULT_DOMAIN = 'apiconnect.ibmcloud.com';
...
function BluemixLogin(hostname, options) {
  ...
  if (domain === DEFAULT_DOMAIN && region in REGION_ENVIRONMENT_MAP) {
    this.tokenKey = [ REGION_ENVIRONMENT_MAP[region], domain ].join('.');
  }
  ...
  } else if (domain === DEFAULT_DOMAIN || domain.includes('apim.ibmcloud.com')) {
    this.loginServerUrl = 'https://login.service.' + hostname;
  } else {
    this.loginServerUrl = 'https://login-service-apiconnect.' + domain;
  }

  if (options.eulaServerUrl) {
    this.eulaServerUrl = options.eulaServerUrl;
  } else if (domain === DEFAULT_DOMAIN || domain.includes('apim.ibmcloud.com')) {
    this.eulaServerUrl = 'https://licensing.service.' + hostname;
  } else {
    this.eulaServerUrl = 'https://licensing-service-apiconnect.' + domain;
  }
}
